Hi <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="25px" height="25px"> My name is Shamlo.
========================

I'm a full-stack engineer.
--------------------------

A passionate full-stack engineer 🚀 from Kurdistan, currently learning more about full-stack technologies and practicing MERN stack🙍🏽‍♂️, bedsides programming, I enjoy reading, meditating, and playing video games.

* 🌍  I'm based in Kurdistan
* 🖥️  See my portfolio at [My Portfolio](http://shamlo.vercel.app/).
* ✉️  You can contact me at [shamlooo@yahoo.com](mailto:shamlooo@yahoo.com).
* 🚀  I'm currently working on [Instagram clone app](http://github.com/shammlo/instagram-clone).
* 🧠  I'm learning More about MERN stack.
* 🤝  I'm open to collaborating on Sass, TypeScript, JavaScript, React, Next, Node, Express, MongoDB, Mongoose.
